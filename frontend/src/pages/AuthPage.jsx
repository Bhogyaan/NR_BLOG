...
const AuthPage = () => {
 ...
 const particlesOptions = {
  particles: {
    number: {
      value: 100, // Reduced particle count for a cleaner look
      density: {
        enable: true,
        value_area: 1200 // Adjusted area for better spread
      }
    },
    color: {
      value: ['#3498db', '#2ecc71', '#e74c3c', '#f39c12', '#9b59b6'] // Professional color palette
    },
    shape: {
      type: ['circle'], // Simplified to circles only
      stroke: {
        width: 1,
        color: '#ffffff'
      }
    ...
    move: {
      enable: true,
      speed: 3,
      direction: 'none', // More uniform movement
      random: false,
      straight: false,
      out_mode: 'out', // Particles exit the canvas
      bounce: false,
      attract: {
        enable: false,
        rotateX: 600,
  ...
  interactivity: {
    ...
    events: {
      onhover: {
        enable: true,
        mode: 'repulse' // Subtle interaction on hover
      },
      onclick: {
        enable: true,
        mode: 'push'
